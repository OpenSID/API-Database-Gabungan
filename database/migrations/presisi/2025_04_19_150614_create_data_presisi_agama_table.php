...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (! Schema::connection('openkab')->hasTable('data_presisi_aktivitas_agama')) {
            Schema::connection('openkab')->create('data_presisi_aktivitas_agama', static function (Blueprint $table) {
                $table->uuid()->primary();
                ...
                $table->integer('rtm_id')->nullable()->index('FK_data_presisi_aktivitas_agama_rtm');
                $table->integer('keluarga_id')->nullable()->index('FK_data_presisi_aktivitas_agama_keluarga');
