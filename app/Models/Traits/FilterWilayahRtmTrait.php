...
trait FilterWilayahRtmTrait
{
    ...
    public function scopeFilterKabupaten($query)
    {
        if (request('kode_kabupaten')) {
            return $query->whereIn('tweb_rtm.config_id', function ($kabupaten) {
    ...
    public function scopeFilterKecamatan($query)
    {
        if (request('kode_kecamatan')) {
            return $query->whereIn('tweb_rtm.config_id', function ($kecamatan) {
    ...
    public function scopeFilterDesa($query)
    {
        if (request('config_desa')) {
            return $query->where('tweb_rtm.config_id', request('config_desa'));
        }
