...
class DataPresisiSeniBudayaTransformer extends TransformerAbstract
{
    public function transform(DataPresisiSeniBudaya $item)
    {
        return [
            ...
            'jenis_seni_yang_dikuasai' => is_array($item->jenis_seni_yang_dikuasai) ? $item->jenis_seni_yang_dikuasai : [],
            'jenis_seni_value' => is_array($item->jenis_seni_yang_dikuasai) ? $item->jenis_seni_yang_dikuasai['jenis_seni_value'] ?? 'TIDAK TAHU' : 'TIDAK TAHU',
            'sub_jenis_seni' => is_array($item->jenis_seni_yang_dikuasai) ? $item->jenis_seni_yang_dikuasai['sub_jenis_seni'] ?? 'TIDAK TAHU' : 'TIDAK TAHU',
