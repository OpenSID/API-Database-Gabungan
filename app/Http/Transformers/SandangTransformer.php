...
{
    public function transform(Penduduk $item)
    {
        return [
            'id' => $item->id,
            'config_id' => $item->config_id,
            'nik' => $item->nik ?? 'TIDAK TAHU',
            'no_kk' => $item->rtm->no_kk ?? 'TIDAK TAHU',
            'nama' => $item->nama ?? 'TIDAK TAHU',
            'rtm_id' => $item->rtm->id ?? 'TIDAK TAHU',
            'jml_pakaian_yg_dimiliki' => optional(optional($item->rtm)->dataPresisiSandang)->jml_pakaian_yg_dimiliki ?? 'TIDAK TAHU',
            'frekwensi_beli_pakaian_pertahun' => optional(optional($item->rtm)->dataPresisiSandang)->frekwensi_beli_pakaian_pertahun ?? 'TIDAK TAHU',
            'jenis_pakaian' => optional(optional($item->rtm)->dataPresisiSandang)->jenis_pakaian ?? 'TIDAK TAHU',
            'frekwensi_ganti_pakaian' => optional(optional($item->rtm)->dataPresisiSandang)->frekwensi_ganti_pakaian ?? 'TIDAK TAHU',
            'tmpt_cuci_pakaian' => optional(optional($item->rtm)->dataPresisiSandang)->tmpt_cuci_pakaian ?? 'TIDAK TAHU',
            'jml_pakaian_seragam' => optional(optional($item->rtm)->dataPresisiSandang)->jml_pakaian_seragam ?? 'TIDAK TAHU',
            'jml_pakaian_sembahyang' => optional(optional($item->rtm)->dataPresisiSandang)->jml_pakaian_sembahyang ?? 'TIDAK TAHU',
            'jml_pakaian_kerja' => optional(optional($item->rtm)->dataPresisiSandang)->jml_pakaian_kerja ?? 'TIDAK TAHU',
            'tanggal_pengisian' => optional(optional($item->rtm)->dataPresisiSandang)->tanggal_pengisian ?? 'TIDAK TAHU',
            'status_pengisian' => optional(optional($item->rtm)->dataPresisiSandang)->status_pengisian ?? 'TIDAK TAHU',
        ];
    }
