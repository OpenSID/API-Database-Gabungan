...
class DataPresisiAgamaRepository
{
    public function index()
    {
        return QueryBuilder::for(DataPresisiAgama::tahunAktif()->filterWilayah())
            ->allowedFilters([
            ...
            ->allowedSorts(['id', 'rtm_id', 'keluarga_id', 'anggota_id', 'config_id', 'penduduk.nik', 'penduduk.nama'])
            ->jsonPaginate();
    }
}
